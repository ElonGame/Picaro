...
namespace MapGeneratorProject
{
    static public class RoomMaker
    {
        ...
        static public void MakeRooms(ref AreaMap new_map, ref AreaMapTemplate template)
        {
        ...
        static public void MakeRoom(ref AreaMap new_map, ref AreaMapTemplate template)
        {
        ...
        static public void SetRoomBarrier(ref AreaMap new_map, ref AreaMapTemplate template, int room_ID)
        {
        ...
        static public void SetRectRoomArea(ref AreaMap new_map, ref AreaMapTemplate template)
        {
        ...
        static public void MakeRoomArea(ref AreaMap new_map, ref AreaMapTemplate template)
        {
        ...
        static public void MakeRect(ref Rectangle rect, ref AreaMap new_map, ref AreaMapTemplate template, ref Point r_size)
        {
            MakeRndRect(ref rect, ref new_map.xRange, ref new_map.yRange, ref r_size, ref r_size);
        }

        static public float MakeRectUntil(ref Rectangle rect, ref AreaMap new_map, ref AreaMapTemplate template, int max_fails)
        {
            int tries = 0;
            int fails = 0;
            float fail_rate = 0f;
        ...
        static public Sizes GetRndRmSize(ref AreaMapTemplate template, int room_index)
        {
            int size_index = 0;
        ...
        static public int GetRoomTypeProb(ref AreaMapTemplate template, ref RoomTypes room_type)
        {
