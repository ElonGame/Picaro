...
namespace LibraryProject.Map
{
    ...
    public class TileSet
    {
        ...
        //private List<Point> bgTileSourcesWall;
        //private List<Point> bgTileSourcesRoom;
        //private List<Vector3> bgAnimatedTileIndicesWall; // index, #frames, #ms per frame
        //private List<Vector3> bgAnimatedTileIndicesRoom; // index, #frames, #ms per frame
        //private List<Point> fgTileSourcesWall;
        //private List<Point> fgTileSourcesRoom;
        //private List<Vector3> fgAnimatedTileIndicesWall; // index, #frames, #ms per frame
        //private List<Vector3> fgAnimatedTileIndicesRoom; // index, #frames, #ms per frame
        ...
        public TileSet()
        {
            //bgTileSourcesWall = new List<Point>();
            //bgTileSourcesRoom = new List<Point>();
            //bgAnimatedTileIndicesWall = new List<Vector3>();
            //bgAnimatedTileIndicesRoom = new List<Vector3>();
            //fgTileSourcesWall = new List<Point>();
            //fgTileSourcesRoom = new List<Point>();
            //fgAnimatedTileIndicesWall = new List<Vector3>();
            //fgAnimatedTileIndicesRoom = new List<Vector3>();
